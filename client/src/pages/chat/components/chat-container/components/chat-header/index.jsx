                    ...
                    <div className="h-10 w-10 sm:h-12 sm:w-12 relative">
                        { selectedChatType === "contact" ? <Avatar className="h-10 sm:h-12 w-10 sm:w-12 rounded-full overflow-hidden">
                            {selectedChatData.image ? (
                                ...
                                <div className={`uppercase h-10 w-10 sm:h-12 sm:w-12 text-md sm:text-lg border-[1px] flex items-center justify-center rounded-full ${getColor(selectedChatData.color)}`}>
