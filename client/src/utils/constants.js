...
export const SEARCH_CONTACT_ROUTES = `${CONTACTS_ROUTE}/search`;
...
export const EDIT_CHANNEL_ROUTE = `${CHANNEL_ROUTES}/edit-channel`;
export const GET_USER_CHANNELS_ROUTE = `${CHANNEL_ROUTES}/get-user-channels`;
export const GET_CHANNEL_MESSAGES = `${CHANNEL_ROUTES}/get-channel-messages`;
export const SEARCH_CHANNEL_ROUTES = `${CHANNEL_ROUTES}/search`;
export const GET_CHANNEL = `${CHANNEL_ROUTES}/get-channel`;